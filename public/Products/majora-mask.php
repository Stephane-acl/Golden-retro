        ...
        <?php
        $title = "TLoZ Majora Mask";
        $css = "../CSS/produits_style.css";
        include "../_header.php";?>

  <main>
        <!--name of the game-->
        <h1 class="product-game-title"><a href="../index.php" title="Home">Home/</a><a href="../Platforms/nintendo-64.php" title="Nintendo-64">Nintendo-64/</a>Zelda Majora's Mask</h1>
        <hr>
