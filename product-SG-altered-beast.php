        <?php include "_headdr.php";?>
        <link rel="stylesheet" type="text/css" href="CSS/produits_style.css">

  <main>
        <!--name of the game-->
        <h1 class="product-game-title"><a href="#" title="Home">Home/</a><a href="#" title="Sega-Genesis">Sega-Genesis/</a>Altered Beast</h1>
        <hr>
        <div class="product-img-and-description">
          <!--game picture-->
          <div class="product-img-container">
            <div class="product-image-cotation-bloc">
                <img src="Images/games/sega-genesis/altered-beast-genesis.png" class="game-image" alt="Altered Beast">
